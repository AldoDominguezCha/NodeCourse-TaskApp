...
MongoClient.connect(connectionURL, {useUnifiedTopology : true}, (error, client) => {
    ...
    //we need to create an idObject with it
    usersCollection.findOne({ _id : ObjectID('5fc1a1970a1a273a044bf522') }, (error, result) => {
        assert.strictEqual(null, error)
        console.log(result)
    })
    ...
    //here we just get the count of the documents that cursor contains
